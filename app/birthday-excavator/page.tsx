  ...
  return (
    ...
    <div className="flex justify-center items-center bg-slate-200 relative">
        <div className="bg-cover sm:bg-contain bg-no-repeat min-h-screen flex justify-center items-center relative w-[450px] bg-center mx-auto z-10 overflow-x-hidden" 
            style={{ 
                backgroundImage: `url(https://img.freepik.com/free-photo/excavator-digging-ground-day-light_23-2149194795.jpg?t=st=1719235562~exp=1719239162~hmac=bf19b41e232243121d0ed8ae8ea1422b9280f54816fc0d9d1a8a53e1309aca39&w=900)`,
            ...
            {showSections && (
                <>
                    ...
                    <div className="flex justify-center items-center"
                        ...
                        data-aos="fade-up"
                    >
                        <img src="https://asset.menica.pro/cartoon-drawing-yellow-excavator-with-large-excavator-it(1).png" style={{
                            width: '50%',
                            height: 'auto'
                        }}/>
                    </div>
                    ...
                    >
                        ...
                        <img src="https://asset.menica.pro/drawing-yellow-excavator-with-word-excavator-it(1).png" style={{
                            width: '50%',
                            height: 'auto'
                        }}/>
                    </div>
                    ...
                    <section id="section5" className="p-4 h-auto sm:min-h-[calc(100vh-80px)] flex flex-col justify-start shadow-md bg-[#533625] bg-opacity-80  w-full rounded-lg mb-10">
                        <img src="https://asset.menica.pro/drawing-yellow-excavator-with-word-excavator-it(1).png" alt="Astronaut" className="mx-auto"/>
