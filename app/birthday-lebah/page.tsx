  ...
  return (
    ...
    <div className="flex justify-center items-center bg-slate-200 relative">
        <div className="bg-cover sm:bg-contain bg-no-repeat min-h-screen flex justify-center items-center relative w-[450px] bg-center mx-auto z-10 overflow-x-hidden" 
            style={{ 
                backgroundImage: `url(https://terhubung.id/wp-content/uploads/05.-HONEY-BEE-BG.jpeg)`,
        ...
        >
            <button className={`text-[0.5rem] w-full uppercase items-center py-2 px-1 sm:px-4 mb-4 flex flex-col ${currentSection === 'section1' ? 'bg-[#9B692C]' : ''}`} onClick={() => scrollToSection('section1')}>
                <MdOutlineKeyboardDoubleArrowDown size={15}/>
                Beranda
            </button>
            <button className={`text-[0.5rem] w-full uppercase items-center flex flex-col transition-all duration-300 py-2 px-1 sm:px-4 mb-4 ${currentSection === 'section2' ? 'bg-[#9B692C]' : ''}`} onClick={() => scrollToSection('section2')}>
                <MdOutlineKeyboardDoubleArrowDown size={15}/>
                Beranda
            </button>
            <button className={`text-[0.5rem] w-full uppercase flex items-center flex-col transition-all duration-300 py-2 px-1 sm:px-4 mb-4 ${currentSection === 'section3' ? 'bg-[#9B692C]' : ''}`} onClick={() => scrollToSection('section3')}>
                <MdOutlineKeyboardDoubleArrowDown size={15}/>
                Beranda
            </button>
            <button className={`text-[0.5rem] w-full uppercase flex items-center flex-col transition-all duration-300 py-2 px-1 sm:px-4 mb-4 ${currentSection === 'section4' ? 'bg-[#9B692C]' : ''}`} onClick={() => scrollToSection('section4')}>
                <MdOutlineKeyboardDoubleArrowDown size={15}/>
                Beranda
            </button>
            <button className={`text-[0.5rem] w-full uppercase flex items-center flex-col transition-all duration-300 py-2 px-1 sm:px-4 ${currentSection === 'section5' ? 'bg-[#9B692C]' : ''}`} onClick={() => scrollToSection('section5')}>
            <MdOutlineKeyboardDoubleArrowDown size={15}/>
                Beranda
            </button>
        </div>
        ...
        >
           ...
           <section id="section1" className="z-50 p-4 bg-transparent h-[calc(100vh-80px)] flex flex-col justify-center w-full rounded-lg mb-10">
                ...
                <div className="text-center text-[black]">1<sup>ST</sup> BIRTHDAY PARTY</div>
                <img src="https://terhubung.id/wp-content/uploads/05.-HONEY-BEE-01.png" alt="Astronaut" className="mx-auto"/>
                <div className="text-center px-6 py-2 border border-white font-extrabold text-white bg-[#F0A038] bg-opacity-80 rounded-md mt-2">
            ...
            {showSections && (
                <>
                    ...
                    <section id="section2" className="px-4 min-h-[calc(70vh)] h-auto py-16 flex flex-col justify-start bg-[#F0A038] bg-opacity-80 shadow-md w-full rounded-lg">
                    ...
                    <p className="text-center text-3xl">Ke Acara Ulang Tahunku</p>
                        ...
                        />
                    <div className="text-[#9B692C] text-3xl text-center my-6">
                        AZKA NAUFAL PUTRA
                    </div>
                    ...
                    >
                        <img src="https://terhubung.id/wp-content/uploads/05.-HONEY-BEE-02.png" style={{
                            width: '50%',
                            height: 'auto'
                        }}/>
                    </div>
                    ...
                    <section id="section3" className="p-4 h-auto sm:min-h-[calc(100vh-80px)] flex flex-col justify-start shadow-md bg-[#F0A038] bg-opacity-80 w-full rounded-lg mb-10">
                        ...
                        <div className="p-4 flex flex-col justify-center shadow-md bg-[#fff] w-full rounded-lg border-[#F0A038] border-4 text-center">
                                ...
                                <div className='text-[#9B692C] text-9xl font-extrabold'>
                                    26
                                </div>
                                ...
                                <div className='text-[#F0A038] text-xl font-extrabold mt-3'>
                                    <div className='text-[#9B692C] text-5xl'>
                                        MARGO CITY
                                    </div>
                    ...
                    <section id="section5" className="p-4 h-auto sm:min-h-[calc(100vh-80px)] flex flex-col justify-start shadow-md bg-[#F0A038] bg-opacity-80 w-full rounded-lg mb-10">
                        ...
                        <div className="text-[#9B692C] text-lg text-center my-6">
