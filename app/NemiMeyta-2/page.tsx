        ...
        <div className="w-[70%] z-50 text-center">
            ...
            <div className="flex justify-around items-center mt-7 flex-col">    
                <div className="text-left flex flex-row">
                    <img src="https://ik.imagekit.io/vtvggda66/menicaid6_MLweMltp-.png" alt="Nemi Photo" className="w-32 h-auto shadow-md mx-auto"
                        style={{
                            height: 'fit-content'
                        }}
                    />
                    ...
                    <div className="text-lg text-[#2B6F51] mt-3 ml-4" style={{ fontFamily: 'Prata' }}>
                        Mahanaim Purba, S.Sn
                    </div>
                ...
                <div className="text-left flex flex-row mt-5">
                    <img src="https://ik.imagekit.io/vtvggda66/menicaid6_tKdAiCowm.png" alt="Meyta Photo" className="w-32 h-auto shadow-md mx-auto"
                        style={{
                            height: 'fit-content'
                        }}
                    />
