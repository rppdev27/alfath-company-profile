...
export default function Home() {
  ...
  return (
    <>
        <div className="bg-white p-0 m-0 overflow-hidden">
            ...
            <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="md:flex md:items-center md:gap-12">
                    ...
                    <ul className="flex items-center gap-6 text-sm">
                        <li>
                        <a className="text-gray-600 transition hover:text-gray-500/75" href="#"> Tentang </a>
                        </li>

                        <li>
                        <a className="text-gray-600 transition hover:text-gray-500/75" href="#"> Layanan </a>
                        </li>
            ...
            <section className="bg-slate-200">
                <div className="flex pt-16 pb-6">
                    <div className="pl-16 bg-transparent w-full flex-row items-center hidden sm:flex">

                            <h1 className="text-3xl font-extrabold sm:text-5xl" data-aos="fade-left">
                                Car Rental.
                                <strong className="font-extrabold text-slate-700 sm:block"> Trusted by Many. </strong>
                            </h1>

                            {/* <p className="mt-4 text-base"  data-aos="fade-right">
                                Lorem ipsum dolor sit amet consectetur, adipisicing elit. 
                            </p> */}

                    </div>
                    <div className="flex flex-col justify-end w-full">
                    <section className="bg-transparent mb-14 px-6">
                        <div className="mx-auto max-w-3xl text-center">
                        <h1 className="text-xl sm:text-3xl font-extrabold text-slate-700 sm:block" data-aos="fade-left">Book Now</h1>
                        <p className="mt-4 text-gray-500 sm:text-base">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit.
                        </p>
                        <Tabs defaultValue="account" className="w-[80%] sm:w-[60%] mx-auto mt-5 text-left"  data-aos="fade-left">
                            <TabsList className="grid w-full grid-cols-2">
                                <TabsTrigger value="account">Pribadi</TabsTrigger>
                                <TabsTrigger value="password">Korporasi</TabsTrigger>
                            </TabsList>
                            <TabsContent value="account">
                                ...
                                <div className="space-y-1">
                                    <Label htmlFor="name">Driver/Lepas Kunci</Label>
                                    <Select>
                                        ...
                                        <SelectGroup>
                                                ...
                                                <SelectItem key='1' value={'with Driver'}>with Driver</SelectItem>
                                                <SelectItem key='2' value={'Lepas Kunci'}>Lepas Kunci</SelectItem>
                                    ...
                                    <div className="space-y-1">
                                    <Label htmlFor="name">Jumlah Mobil</Label>
                                    <Input id="username" defaultValue="" />
                                    </div>
                                    <div className="space-y-1">
                                    ...
                                    <Select>
                                        ...
                                        <SelectGroup>
                                                ...
                                                {Array.from({length: 28}, (_, i) => {
                                                    ...
                                                    return <SelectItem key={i} value={formattedTime}>{formattedTime}</SelectItem>
                                                })}
                                        </SelectGroup>
                                        </SelectContent>
                                    </Select>
                                ...
                                <CardFooter className="text-center mx-auto w-full">
            ...
            <div className="mx-auto max-w-screen-xl px-4 py-12 sm:px-6 md:py-16 lg:px-8">
                <div className="mx-auto max-w-3xl text-center">
                <h1 className="text-3xl sm:text-5xl font-extrabold text-slate-700 sm:block"  data-aos="fade-left">Car Type</h1>
                <p className="mt-4 text-gray-500 sm:text-xl">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
                </p>
                </div>

                <div className="mt-8 sm:mt-12"  data-aos="fade-left">

                <Carousel>
                <CarouselContent>
                    {
                        car_type.map((item: any, index: any)=>
                        <CarouselItem className="text-xs basis-1/3 border border-slate-300 m-1 rounded-md shadow-sm">
                            {item.brand}
                            <img src="https://trenotomotif.com/ncs/images/mitsubishi/L100EV/L100EVThumbnail.jpg" width="100%" alt="car rental builder saas"/>
            ...
            <div className="mx-auto max-w-screen-xl px-4 py-12 sm:px-6 md:py-16 lg:px-8">
                <div className="mx-auto max-w-3xl text-center">
                <h1 className="text-3xl sm:text-5xl font-extrabold text-slate-700 sm:block"  data-aos="fade-left">Trending Car</h1>
                <p className="mt-4 text-gray-500 sm:text-xl">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
                </p>
                </div>
            ...
            {/*  Book Now */}
            <section className="bg-white mb-14 px-6">
            <div className="mx-auto max-w-3xl text-center">
            <h1 className="text-3xl sm:text-5xl font-extrabold text-slate-700 sm:block"  data-aos="fade-left">Book Now</h1>
            <p className="mt-4 text-gray-500 sm:text-base">
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
            </p>
            </div>
            <Tabs defaultValue="account" className="sm:w-1/4 w-full mx-auto mt-5"  data-aos="fade-left">
                <TabsList className="grid w-full grid-cols-2">
                    <TabsTrigger value="account">Driver</TabsTrigger>
                    <TabsTrigger value="password">Lepas Kunci</TabsTrigger>
                </TabsList>
                <TabsContent value="account">
                    <Card>
                    {/* <CardHeader>
            ...
            <footer className="bg-gray-100">
                <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
                    ...
                    <li>
                        <a className="text-gray-700 transition hover:text-gray-700/75" href="#"> Layanan </a>
                    </li>
