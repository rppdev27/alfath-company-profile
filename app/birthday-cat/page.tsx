  ...
  return (
    ...
    <div className="flex justify-center items-center bg-slate-200 relative">
        <div className="bg-cover sm:bg-contain bg-no-repeat min-h-screen flex justify-center items-center relative w-[450px] bg-center mx-auto z-10 overflow-x-hidden" 
            style={{ 
                backgroundImage: `url(https://asset.menica.pro/Default_colorfull_living_room_for_orange_cat_ambience_but_ther_2.jpg)`,
        ...
        >
           ...
           <section id="section1" className="z-50 p-4 bg-transparent h-[calc(100vh-80px)] flex flex-col justify-center w-full rounded-lg mb-10">
                ...
                <img src="https://asset.menica.pro/Default_orange_cat_cute_1.png" alt="Astronaut" className="mx-auto"/>
                <div className="text-center px-6 py-2 border border-white font-extrabold text-white bg-[#da8947] bg-opacity-80 rounded-md mt-2">
                    ...
                    className="w/3-4 cursor-pointer text-center transition-transform duration-300 ease-in-out transform hover:scale-105 p-2 font-extrabold text-white bg-[#2a7689] text-3xl rounded-md mb-4 flex  items-center justify-center" onClick={() => scrollToSection('section2')}>
            ...
            {showSections && (
                <>
                    ...
                    <section id="section2" className="px-4 min-h-[calc(70vh)] h-auto py-16 flex flex-col justify-start bg-[#2a7689] bg-opacity-80  shadow-md w-full rounded-lg">
                    ...
                    >
                        <img src="https://asset.menica.pro/Default_orange_cat_cute_0.png" style={{
                            width: '50%',
                            height: 'auto'
                        }}/>
                    </div>
                    
                    <section id="section3" className="p-4 h-auto sm:min-h-[calc(100vh-80px)] flex flex-col justify-start shadow-md bg-[#2a7689] bg-opacity-80  w-full rounded-lg mb-10">
                    ...
                    <section id="section4" className="p-4 h-auto sm:min-h-[calc(100vh-80px)] flex flex-col justify-start shadow-md bg-[#2a7689] bg-opacity-80  w-full rounded-lg mb-10">
                    ...
                    <section id="section5" className="p-4 h-auto sm:min-h-[calc(100vh-80px)] flex flex-col justify-start shadow-md bg-[#2a7689] bg-opacity-80  w-full rounded-lg mb-10">
                        <img src="https://asset.menica.pro/Default_orange_cat_cute_1.png" alt="Astronaut" className="mx-auto"/>
                        <div className="text-[#fff] text-3xl text-center my-6 uppercase">
                            Terima Kasih
                        </div>
