  ...
  return (
    ...
    <div className="flex justify-center items-center bg-slate-200 relative">
        <div className="bg-cover sm:bg-contain bg-no-repeat min-h-screen flex justify-center items-center relative w-[450px] bg-center mx-auto z-10 overflow-x-hidden" 
            style={{ 
                backgroundImage: `url(https://terhubung.id/wp-content/uploads/10.-PINK-ELEPHANT-BG.jpeg)`,
        ...
        >
            <button className={`rounded-l-lg text-[0.5rem] uppercase items-center py-2 px-4 mb-4 flex flex-col ${currentSection === 'section1' ? 'bg-[#F97580]' : ''}`} onClick={() => scrollToSection('section1')}>
                <MdOutlineKeyboardDoubleArrowDown size={15}/>
                Beranda
            </button>
            <button className={`rounded-l-lg text-[0.5rem] uppercase items-center flex flex-col transition-all duration-300 py-2 px-4 mb-4 ${currentSection === 'section2' ? 'bg-[#F97580]' : ''}`} onClick={() => scrollToSection('section2')}>
                <MdOutlineKeyboardDoubleArrowDown size={15}/>
                Beranda
            </button>
            <button className={`rounded-l-lg text-[0.5rem] uppercase flex items-center flex-col transition-all duration-300 py-2 px-4 mb-4 ${currentSection === 'section3' ? 'bg-[#F97580]' : ''}`} onClick={() => scrollToSection('section3')}>
                <MdOutlineKeyboardDoubleArrowDown size={15}/>
                Beranda
            </button>
            <button className={`rounded-l-lg text-[0.5rem] uppercase flex items-center flex-col transition-all duration-300 py-2 px-4 mb-4 ${currentSection === 'section4' ? 'bg-[#F97580]' : ''}`} onClick={() => scrollToSection('section4')}>
                <MdOutlineKeyboardDoubleArrowDown size={15}/>
                Beranda
            </button>
            <button className={`rounded-l-lg text-[0.5rem] uppercase flex items-center flex-col transition-all duration-300 py-2 px-4 mb-4 ${currentSection === 'section5' ? 'bg-[#F97580]' : ''}`} onClick={() => scrollToSection('section5')}>
            <MdOutlineKeyboardDoubleArrowDown size={15}/>
                Beranda
            </button>
        </div>
        ...
        >
           ...
           <section id="section1" className="z-50 p-4 bg-transparent h-[calc(100vh-80px)] flex flex-col justify-center w-full rounded-lg mb-10">
                ...
                <p className="textstroke text-center text-[48px] font-bold leading-tight tracking-[1.5px] text-[#F97580] font-['Londrina_Solid'] stroke-2 stroke-white">
                    AZKA NAUFAL
                </p>
                <div className="text-center text-[#fff]">1<sup>ST</sup> BIRTHDAY PARTY</div>
                <img src="https://terhubung.id/wp-content/uploads/06.-PINK-ELEPHANT-01.png" alt="Astronaut" className="mx-auto"/>
                <div className="text-center px-6 py-2 border border-white font-extrabold text-white bg-[#416A3E] bg-opacity-80 rounded-md mt-2">
                    ...
                    className="w/3-4 cursor-pointer text-center transition-transform duration-300 ease-in-out transform hover:scale-105 p-2 font-extrabold text-white bg-[#F97580] text-3xl rounded-md mb-4 flex  items-center justify-center" onClick={() => scrollToSection('section2')}>
            ...
            {showSections && (
                <>
                    ...
                    <p className="text-center text-3xl">Ke Acara Ulang Tahunku</p>
                        ...
                        />
                    <div className="text-[#F97580] text-3xl text-center my-6">
                        AZKA NAUFAL PUTRA
                    </div>
                    ...
                    >
                        <img src="https://terhubung.id/wp-content/uploads/06.-PINK-ELEPHANT-02.png" style={{
                            width: '50%',
                            height: 'auto'
                        }}/>
                    </div>
                    ...
                    <section id="section3" className="p-4 h-auto sm:min-h-[calc(100vh-80px)] flex flex-col justify-start shadow-md bg-[#416A3E] bg-opacity-80 w-full rounded-lg mb-10">
                        ...
                        <div className="text-[#F97580] text-3xl text-center my-6 uppercase">
                            Save The Date
                        </div>
                        <div className="text-[#F97580] text-3xl text-center my-6 uppercase">
                           [09.09.09.09]
                        ...
                        <div className="p-4 flex flex-col justify-center shadow-md bg-[#fff] w-full rounded-lg border-[#F0A038] border-4 text-center">
                                ...
                                <div className='text-[#F97580] text-9xl font-extrabold'>
                                    26
                                </div>
                                ...
                                <div className='text-[#416A3E] text-xl font-extrabold mt-3'>
                                    <div className='text-[#F97580] text-5xl'>
                                        MARGO CITY
                                    </div>
                    ...
                    <section id="section5" className="p-4 h-auto sm:min-h-[calc(100vh-80px)] flex flex-col justify-start shadow-md bg-[#416A3E] bg-opacity-80 w-full rounded-lg mb-10">
                        ...
                        <div className="text-[#F97580] text-lg text-center my-6">
