  ...
  return (
    ...
    <div className="flex justify-center items-center bg-slate-200 relative">
        <div className="bg-cover sm:bg-contain bg-no-repeat min-h-screen flex justify-center items-center relative w-[450px] bg-center mx-auto z-10 overflow-x-hidden" 
            style={{ 
                backgroundImage: `url(https://img.freepik.com/free-photo/firefighters-helping-out-with-nature-wildfire_23-2150789237.jpg?t=st=1719294882~exp=1719298482~hmac=79fdf99b7e3c3913df11fbc783077f3389435da20d94c72994cf8bad1f4e21d2&w=900)`,
        ...
        >
           ...
           <section id="section1" className="z-50 p-4 bg-transparent h-[calc(100vh-80px)] flex flex-col justify-center w-full rounded-lg mb-10">
                ...
                <img data-aos="fade-up" src="https://asset.menica.pro/anime-style-fireman-character(1).png" alt="Astronaut" className="mx-auto" 
                    style={{
                        height: '50%',
                        width: 'auto'
                    }}
            ...
            {showSections && (
                <>
                    ...
                    <section id="section2" className="px-4 min-h-[calc(70vh)] h-auto py-16 flex flex-col justify-start bg-[#533625] bg-opacity-80  shadow-md w-full rounded-lg">
                    ...
                    <div className="flex justify-center items-center"
                        ...
                        data-aos="fade-up"
                    >
                        <img src="https://asset.menica.pro/fire-engine-red-truck-emergency-vehicle-rescue-ladder-automobile-isolated-white-design-cartoon-style-vector-illustration.png" style={{
                            width: '50%',
                            height: '20%'
                        }}/>
                    </div>
                    
                    <section id="section3" className="p-4 h-auto sm:min-h-[calc(100vh-80px)] flex flex-col justify-start shadow-md bg-[#533625] bg-opacity-80  w-full rounded-lg mb-10">
                    ...
                    <section id="section4" className="p-4 h-auto sm:min-h-[calc(100vh-80px)] flex flex-col justify-start shadow-md bg-[#533625] bg-opacity-80  w-full rounded-lg mb-10">
                    ...
                    <section id="section5" className="p-4 h-auto sm:min-h-[calc(100vh-80px)] flex flex-col justify-start shadow-md bg-[#533625] bg-opacity-80  w-full rounded-lg mb-10">
                        <img src="https://asset.menica.pro/anime-style-fireman-character(1).png" alt="Astronaut" className="mx-auto" style={{
                            width: '50%'
                        }}/>
