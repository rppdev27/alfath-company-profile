  ...
  return (
    ...
    <div className="flex justify-center items-center bg-slate-200 relative">
        <div className="bg-cover sm:bg-contain bg-no-repeat min-h-screen flex justify-center items-center relative w-[450px] bg-center mx-auto z-10 overflow-x-hidden" 
            style={{ 
                backgroundImage: `url(https://asset.menica.pro/Default_war_ambience_tone_color_green_for_background_wallpape_2.jpg)`,
        ...
        >
            <button className={`text-[0.5rem] w-full uppercase items-center py-2 mb-4 px-2 flex flex-col ${currentSection === 'section1' ? 'text-[#6fff6f]' : ''}`} onClick={() => scrollToSection('section1')}>
                <FaRegCircleDot size={15}/>
                {/* Beranda */}
            </button>
            <button className={`text-[0.5rem] w-full uppercase items-center flex flex-col transition-all duration-300 py-2 mb-4 ${currentSection === 'section2' ? 'text-[#6fff6f]' : ''}`} onClick={() => scrollToSection('section2')}>
                <FaRegCircleDot size={15}/>
                {/* Beranda */}
            </button>
            <button className={`text-[0.5rem] w-full uppercase flex items-center flex-col transition-all duration-300 py-2 mb-4 ${currentSection === 'section3' ? 'text-[#6fff6f]' : ''}`} onClick={() => scrollToSection('section3')}>
                <FaRegCircleDot size={15}/>
                {/* Beranda */}
            </button>
            <button className={`text-[0.5rem] w-full uppercase flex items-center flex-col transition-all duration-300 py-2 mb-4 ${currentSection === 'section4' ? 'text-[#6fff6f]' : ''}`} onClick={() => scrollToSection('section4')}>
                <FaRegCircleDot size={15}/>
                {/* Beranda */}
            </button>
            <button className={`text-[0.5rem] w-full uppercase flex items-center flex-col transition-all duration-300 py-2 ${currentSection === 'section5' ? 'text-[#6fff6f]' : ''}`} onClick={() => scrollToSection('section5')}>
            <FaRegCircleDot size={15}/>
                {/* Beranda */}
            </button>
        </div>
        ...
        >
           ...
           <section id="section1" className="z-50 p-4 bg-transparent h-[calc(100vh-80px)] flex flex-col justify-center w-full rounded-lg mb-10">
                ...
                <img src="https://asset.menica.pro/kids-holding-indonesia-flag-wearing-army-soldier-military-with-helmet_1162612-1629-removebg-preview.png" alt="Astronaut" className="mx-auto"/>
                <div className="text-center px-6 py-2 border border-white font-extrabold text-white bg-[#484927] bg-opacity-80 rounded-md mt-2">
            ...
            {showSections && (
                <>
                    ...
                    <section id="section2" className="px-4 min-h-[calc(70vh)] h-auto py-16 flex flex-col justify-start bg-[#484927] bg-opacity-80  shadow-md w-full rounded-lg">
                    ...
                    >
                        <img src="https://asset.menica.pro/kids-holding-indonesia-flag-wearing-army-soldier-military-with-helmet_1162612-1629-removebg-preview.png" style={{
                            width: '50%',
                            height: 'auto'
                        }}/>
                    </div>
                    
                    <section id="section3" className="p-4 h-auto sm:min-h-[calc(100vh-80px)] flex flex-col justify-start shadow-md bg-[#484927] bg-opacity-80  w-full rounded-lg mb-10">
                        ...
                        <div className="p-4 flex flex-col justify-center shadow-md bg-[#fff] w-full rounded-lg border-[#F0A038] border-4 text-center">
                                <div className='text-[#F0A038] text-5xl font-extrabold uppercase'>
                                    Minggu
                                </div>
                                <div className='text-[#484927] text-9xl font-extrabold'>
                                    26
                                </div>
                                <div className='text-[#F0A038] text-5xl font-extrabold'>
                                    DES 2024
                                </div>
                                <div className='text-[#F0A038] text-lg font-extrabold'>
                                    13.00 WIB - 15.00 WIB
                                </div>
                                <div className='text-[#F0A038] text-xl font-extrabold mt-3'>
                                    <div className='text-[#484927] text-5xl'>
                                        MARGO CITY
                                    </div>
                                    Jl. Margonda Raya No. 358, Kemiri Muka, Kecamatan Beji, Kota Depok, Jawa Barat 16423
                                </div>
                                <div className="p-2 bg-[#F0A038] text-white text-lg  sm:text-3xl w-2/3 rounded-md my-4 mx-auto flex justify-center items-center font-extrabold mb-10">
                    ...
                    <section id="section4" className="p-4 h-auto sm:min-h-[calc(100vh-80px)] flex flex-col justify-start shadow-md bg-[#484927] bg-opacity-80  w-full rounded-lg mb-10">
                    ...
                    <section id="section5" className="p-4 h-auto sm:min-h-[calc(100vh-80px)] flex flex-col justify-start shadow-md bg-[#484927] bg-opacity-80  w-full rounded-lg mb-10">
                        <img src="https://asset.menica.pro/kids-wearing-army-soldier-military-with-helmet-green-armed-riffle-gun_1162612-1631-removebg-preview.png" alt="Astronaut" className="mx-auto"/>
                        <div className="text-[#fff] text-3xl text-center my-6 uppercase">
                            Terima Kasih
                        </div>
                        <div className="text-[#fff] text-3xl text-center my-6">
                        ...
                        <div className="text-[#484927] text-lg text-center my-6">
