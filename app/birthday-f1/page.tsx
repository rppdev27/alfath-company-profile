  ...
  return (
    ...
    <div className="flex justify-center items-center bg-slate-200 relative">
        <div className="bg-cover sm:bg-contain bg-no-repeat min-h-screen flex justify-center items-center relative w-[450px] bg-center mx-auto z-10 overflow-x-hidden" 
            style={{ 
                backgroundImage: `url(https://asset.menica.pro/f1road.jpg)`,
        ...
        >
            ...
            <button className={`text-[0.5rem] w-full uppercase flex items-center flex-col transition-all duration-300 py-2 ${currentSection === 'section5' ? 'text-[#bd2b2b]' : ''}`} onClick={() => scrollToSection('section5')}>
            <FaRegCircleDot size={15}/>
                {/* Beranda */}
            </button>
        </div>
        ...
        >
           <div className="bg-transparent bg-opacity-80 w-full mx-auto">
            ...
            <section id="section1" className="z-50 p-4 bg-transparent h-[calc(100vh-80px)] flex flex-col justify-center w-full rounded-lg mb-10">
                ...
                <img data-aos="fade-up" src="https://asset.menica.pro/racing-car-isolated-white-background-abstract-silhouette-line-art-vector-illustration(1).png" alt="Astronaut" className="mx-auto"/>
                <div className="text-center px-6 py-2 border border-white font-extrabold text-white bg-[#bd2b2b] bg-opacity-80 rounded-md mt-2">
                    ...
                    <div 
                        ...
                        data-aos="fade-up"
                    className="w/3-4 cursor-pointer text-center transition-transform duration-300 ease-in-out transform hover:scale-105 p-2 font-extrabold text-white bg-[#bd2b2b] text-3xl rounded-md mb-4 flex  items-center justify-center" onClick={() => scrollToSection('section2')}>
            ...
            {showSections && (
                <>
                    ...
                    <section id="section2" className="px-4 min-h-[calc(70vh)] h-auto py-16 flex flex-col justify-start bg-[#bd2b2b] bg-opacity-80  shadow-md w-full rounded-lg">
                    ...
                    >
                        ...
                        <img src="https://asset.menica.pro/red-race-car-with-white-stripe-front(1).png" style={{
                            width: '50%',
                            height: 'auto'
                        }}/>
                    </div>
                    
                    <section id="section3" className="p-4 h-auto sm:min-h-[calc(100vh-80px)] flex flex-col justify-start shadow-md bg-[#bd2b2b] bg-opacity-80  w-full rounded-lg mb-10">
                        ...
                        <div className="p-4 flex flex-col justify-center shadow-md bg-[#fff] w-full rounded-lg border-[#F0A038] border-4 text-center">
                                <div className='text-[#0b4887] text-5xl font-extrabold uppercase'>
                                    Minggu
                                </div>
                                <div className='text-[#a20009] text-9xl font-extrabold'>
                                    26
                                </div>
                                <div className='text-[#0b4887] text-5xl font-extrabold'>
                                    DES 2024
                                </div>
                                <div className='text-[#0b4887] text-lg font-extrabold'>
                                    13.00 WIB - 15.00 WIB
                                </div>
                                <div className='text-[#0b4887] text-xl font-extrabold mt-3'>
                                    <div className='text-[#a20009] text-5xl'>
                                        MARGO CITY
                                    </div>
                                    Jl. Margonda Raya No. 358, Kemiri Muka, Kecamatan Beji, Kota Depok, Jawa Barat 16423
                                </div>
                                <div className="p-2 bg-[#0b4887] text-white text-lg  sm:text-3xl w-2/3 rounded-md my-4 mx-auto flex justify-center items-center font-extrabold mb-10">
                    ...
                    <section id="section4" className="p-4 h-auto sm:min-h-[calc(100vh-80px)] flex flex-col justify-start shadow-md bg-[#bd2b2b] bg-opacity-80  w-full rounded-lg mb-10">
                    ...
                    <section id="section5" className="p-4 h-auto sm:min-h-[calc(100vh-80px)] flex flex-col justify-start shadow-md bg-[#bd2b2b] bg-opacity-80  w-full rounded-lg mb-10">
                        <img src="https://asset.menica.pro/red-formula-1-car-background(1).png" alt="Astronaut" className="mx-auto"/>
