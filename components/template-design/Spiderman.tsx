  ...
  return (
    ...
    <div className="flex justify-center items-center bg-slate-200 relative">
        <div className="bg-cover sm:bg-contain bg-no-repeat min-h-screen flex justify-center items-center relative w-[450px] bg-center mx-auto z-10 overflow-x-hidden" 
            style={{ 
                backgroundImage: `url(https://asset.menica.pro/Default_sky_tall_building_for_spiderman_background_3.jpg)`,
            ...
            {showSections && (
                <>
                    ...
                    <section id="section5" className="p-4 h-auto sm:min-h-[calc(100vh-80px)] flex flex-col justify-start shadow-md bg-[#03418a] bg-opacity-80  w-full rounded-lg mb-10">
                        <img src="https://asset.menica.pro/Default_spiderman_3d_cartoon_0.png" alt="Astronaut" className="mx-auto"/>
                        <div className="text-[#fff] text-3xl text-center my-6 uppercase">
                            Terima Kasih
                        </div>
